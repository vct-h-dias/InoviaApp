...
class Foto2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toFinalizar.setOnClickListener(){
            irFinalizar()
        }
    ...
    private fun CamOff(){
        binding.Capture2.visibility = View.GONE
        binding.cameraPreview2.visibility = View.GONE
        binding.toFinalizar.visibility = View.VISIBLE
    }
    ...
    private fun IniciarCam(){
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder().build().also(){ mPreview->
                mPreview.setSurfaceProvider(binding.cameraPreview2.surfaceProvider)
            }
