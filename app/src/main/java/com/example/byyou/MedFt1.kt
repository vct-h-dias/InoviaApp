...
import com.example.byyou.databinding.ActivityMedFt1Binding
import java.io.File
...
class MedFt1 : AppCompatActivity() {
    private lateinit var binding : ActivityMedFt1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMedFt1Binding.inflate(layoutInflater)
        ...
        binding.Capture11.setOnClickListener(){
            tirarFoto()
        }

        binding.toMed11.setOnClickListener(){
            irM()
        }
    ...
    private fun irM(){
        val m = Intent(this, Med1_1::class.java)
        startActivity(m)
    }
        ...
        imagem?.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback{
                override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                    ...
                    binding.picture1.setImageURI(uri)

                    CamOff()

                    Toast.makeText(this@MedFt1, "$msg", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun CamOff(){
        binding.Capture11.visibility = View.GONE
        binding.cameraPreview1.visibility = View.GONE
        binding.toMed11.visibility = View.VISIBLE
    }
    ...
    private fun IniciarCam(){
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder().build().also(){ mPreview->
                mPreview.setSurfaceProvider(binding.cameraPreview1.surfaceProvider)
            }
